...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (cam == null)
        {
            Debug.LogError("P��kameraa ei l�ytynyt!");
        }
    }
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning("rotationFix ei ole m��ritelty!");
        }
        ...
        if (stats == null)
        {
            Debug.LogError("PlayerStats-komponenttia ei l�ytynyt t�st� GameObjectista!");
        }

        if (rb == null)
        {
            Debug.LogError("Rigidbody2D-komponenttia ei l�ytynyt t�st� GameObjectista!");
        }
    }
